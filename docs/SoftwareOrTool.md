...
```mermaid
 classDiagram
    ...
    click SoftwareOrTool href "../SoftwareOrTool"
      ...
      SoftwareOrTool : contributor_github_name
        
      SoftwareOrTool : contributor_name
        
      SoftwareOrTool : contributor_orcid
        
      SoftwareOrTool : description
        
      SoftwareOrTool : formal_specification
        
      SoftwareOrTool : has_application
        
          
    
        
        
        SoftwareOrTool --> "*" Application : has_application
        click Application href "../Application"
    

        
      SoftwareOrTool : has_relevant_data_substrate
        
          
    
        
        
        SoftwareOrTool --> "*" DataSubstrate : has_relevant_data_substrate
      ...
      SoftwareOrTool : publication
        ...
        SoftwareOrTool --> "0..1" Reference : publication
      ...
      SoftwareOrTool : responsible_organization
      ...
      SoftwareOrTool : used_in_bridge2ai
