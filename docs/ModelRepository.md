...
```mermaid
 classDiagram
    ...
    click ModelRepository href "../ModelRepository"
      ...
      ModelRepository : has_application
        
          
    
        
        
        ModelRepository --> "*" Application : has_application
        click Application href "../Application"
    

        
      ModelRepository : has_relevant_data_substrate
      ...
      ModelRepository : publication
        ...
        ModelRepository --> "0..1" Reference : publication
      ...
      ModelRepository : used_in_bridge2ai
