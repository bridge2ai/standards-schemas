...
```mermaid
 classDiagram
    ...
    click OntologyOrVocabulary href "../OntologyOrVocabulary"
      ...
      OntologyOrVocabulary : has_application
        
          
    
        
        
        OntologyOrVocabulary --> "*" Application : has_application
        click Application href "../Application"
    

        
      OntologyOrVocabulary : has_relevant_data_substrate
        
          
    
        
        
        OntologyOrVocabulary --> "*" DataSubstrate : has_relevant_data_substrate
      ...
      OntologyOrVocabulary : publication
        ...
        OntologyOrVocabulary --> "0..1" Reference : publication
      ...
      OntologyOrVocabulary : responsible_organization
      ...
      OntologyOrVocabulary : used_in_bridge2ai
